...
$databases = array (
  ...
  array (
    ...
    array (
      'database' => 'drupal',
      'username' => # ADD BEFORE USING,
      'password' => # ADD BEFORE USING,
      'host' => # ADD BEFORE USING,
      'port' => '5432',
      'driver' => 'pgsql',
      'prefix' => '',
    ),
 ...
 *
 */
$drupal_hash_salt = # ADD BEFORE USING;
 ...
 * for you.
 */
$base_url = 'https://cms.hellox.me';  // NO trailing slash!
